...
def plotyearly(main_xarray,std_main_xarray,main_xarray2,std_main_xarray2, Yax,xranges,xtitle,ytitle,plotname,plottitle):
    ...
    ax0.errorbar(main_xarray,Yax,xerr=std_main_xarray,label='2004-2022 Homogenized',marker="o",color='green',
                 linewidth=2,elinewidth=0.01,capsize=4,capthick=2.0)
    ax0.errorbar(main_xarray2,Yax,xerr=std_main_xarray2,label='2004-2022 Non-Homogenized',marker="x",color='red',
                 linewidth=2,elinewidth=0.01,capsize=4,capthick=2.0)
    ...
    print(main_xarray)
    print(std_p5)
    ax0.legend(loc='upper left',frameon=True,fontsize='x-small')
    ...
    plt.savefig('/home/poyraden/Analysis/Homogenization_public/Plots/Plots_hom_eu/' + plotname + '.png')
...
plottitle = f'{sccname} '
plotyearly(main_mean_rdqa_ucint,main_std_rdqa_ucint,main_mean_rorg_ucint,main_std_rorg_ucint, Y,xlim,
           f'ECC - MLS [%]',f'Pressure [hPa]',f'RDif_MLS_v05_-{scname}', plottitle)
