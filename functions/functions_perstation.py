...
def df_drop(dft, st_name):
    if st_name == 'madrid':
        dft = dft.drop(['Pressure', 'LevelCode', 'Tpump', 'unc_Tpump', 'DateTime', 'value_is_NaN',
                        ...
                        'alpha_o3', 'stoich', 'unc_stoich', 'eta_c', 'unc_eta', 'unc_eta_c', 'iBc', 'unc_iBc',
                        'Tpump_cor',
                        'unc_Tpump_cor', 'deltat', 'unc_deltat', 'deltat_ppi', 'unc_deltat_ppi', 'TLab', 'ULab', 'PLab',
                        'x',
                        'psaturated', 'cPH', 'TLabK', 'cPL', 'Phip_ground', 'unc_Phip_ground', 'Cpf', 'unc_Cpf',
                        'Phip_cor',
                        'unc_Phip_cor', 'O3cor', 'O3_nc', 'O3c_eta', 'O3c_etabkg', 'O3c_etabkgtpump',
                        'O3c_etabkgtpumpphigr',
    ...
    if st_name == 'uccle':
        dft = dft.drop(['Tpump', 'unc_Tpump', 'TboxK',
                        ...
                        'alpha_o3', 'stoich', 'unc_stoich', 'eta_c', 'unc_eta', 'unc_eta_c', 'iBc', 'unc_iBc',
                        'Tpump_cor',
                        'unc_Tpump_cor', 'deltat', 'unc_deltat', 'deltat_ppi', 'unc_deltat_ppi', 'TLab', 'cPH', 'TLabK',
                        'cPL',
...
def df_station(dl, datevalue, dml, station):
    ...
    skip_function = 'False'
    return_string = 'fine'
    if ((datevalue == '20020725') | (datevalue == '20050124') | (datevalue == '20191216') | (
            datevalue == '20190524') | (datevalue == '20190528')) & (station == 'lauder'):
        skip_function = 'True'
        return_string = 'stop'
    ...
    if ((datevalue == '20070525') | (datevalue == '20070629') | (datevalue == '20070702') | (
            datevalue == '20070706') | (datevalue == '20070709')
    ...
    if skip_function == 'False':
        ...
        if station == 'lauder':
            ...
            dl[['Time', 'Press', 'Alt', 'Temp', 'RH', 'PO3', 'TPump', 'O3CellI', 'EvapCath', 'WindSp', 'WindDir', 'Lat',
                'Lon',
                'RH1', 'RH2', 'GPSPres', 'GPSAlt', 'GPSTraw', 'GPSTcor', 'GPSRH']] = dl[
                ['Time', 'Press', 'Alt', 'Temp', 'RH', 'PO3', 'TPump', 'O3CellI', 'EvapCath', 'WindSp', 'WindDir',
                 'Lat', 'Lon',
    ...
    if station == 'madrid':
        dl = rename_variables(dl, ['Pressure', 'O3PartialPressure', 'SampleTemperature', 'GPHeight'],
                              ['Pair', 'O3', 'Tpump', 'Height'])
