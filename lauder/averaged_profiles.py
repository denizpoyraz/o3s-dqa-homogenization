...
#     listall.append(df)
#
# name_out = 'Lauder_AllData_DQA_nors80'
...
df1 = pd.read_csv('/home/poyraden/Analysis/Homogenization_public/Files/lauder/DQA_nors80/Lauder_AllData_DQA_nors80.csv')
df2 = pd.read_csv('/home/poyraden/Analysis/Homogenization_public/Files/lauder/DQA_rs80/Lauder_AllData_DQA_rs80.csv')
#
...
Plotname = 'AllPeriod_RS80_profile'
# Plotname = 'RS80'

fig, ax = plt.subplots(figsize=(17, 9))

ax.plot(o3c, y , label = '1989-2022 DQA corrections', marker = 'd', markersize = 6)
ax.plot(o3c2, y , label = '1989-2022 DQA and RS80 corrections', marker = 'd', markersize = 6)
