...
are denoted by 'DQA' in the rest of the manuscript.
 ...
 The stoichiometry correction is relavent for 1986 where 2.5ml is used for cathode solution, and ENSCI sondes were launched
    with 1.0\%-1.0\%B solution strength. The effect of the converison efficiency is shown in Fig~\ref{fig:eta}
                ...
                \begin{figure}
        \centering
\includegraphics[width=1.3\textwidth]{../../Files/lauder/DQA_nors80/Binned/Plots/Eta_vs_Raw_alltimerange.png}
%        \includegraphics[width=0.9\textwidth]{../../Files/lauder/MLS/Plots/Raw_vs_MLS_zoom.pdf}
...
%
                \begin{figure}
        \centering
\includegraphics[width=1.3\textwidth]{../../Files/lauder/DQA_nors80/Binned/Plots/EtaBkg_vs_Eta_alltimerange.png}
%        \includegraphics[width=0.9\textwidth]{../../Files/lauder/MLS/Plots/Raw_vs_MLS_zoom.pdf}
...
%
                    \begin{figure}
        \centering
\includegraphics[width=1.2\textwidth]{../../Files/lauder/DQA_nors80/Binned/Plots/EtaBkgTpump_vs_EtaBkg_alltimerange.png}
%        \includegraphics[width=0.9\textwidth]{../../Files/lauder/MLS/Plots/Raw_vs_MLS_zoom.pdf}
...
%
                        \begin{figure}
        \centering
\includegraphics[width=1.2\textwidth]{../../Files/lauder/DQA_nors80/Binned/Plots/EtaBkgTpumpPhigr_vs_EtaBkgTpump_alltimerange.png}
%        \includegraphics[width=0.9\textwidth]{../../Files/lauder/MLS/Plots/Raw_vs_MLS_zoom.pdf}
...
and polynomial fit with an error of less than $0.03\%$. The effect of this correction is shown in Fig~\ref{fig:pf_eff}.
                        ...
                        \begin{figure}
        \centering
\includegraphics[width=1.2\textwidth]{../../Files/lauder/DQA_nors80/Binned/Plots/EtaBkgTpumpPhigrPhiEff_vs_EtaBkgTpumpPhigr_alltimerange.png}
%        \includegraphics[width=0.9\textwidth]{../../Files/lauder/MLS/Plots/Raw_vs_MLS_zoom.pdf}
    \caption{Pump flow rate correction applied}
            \label{fig:pf_eff}
    \end{figure}
...
WOUDC O3S values is shown in Fig~\ref{fig:fig_dqa_ndacc}.
                        ...
                        \begin{figure}
        \centering
\includegraphics[width=1.2\textwidth]{../../Files/lauder/DQA_nors80/Binned/Plots/DQA_vs_Raw_alltimerange.png}
%        \includegraphics[width=0.9\textwidth]{../../Files/lauder/MLS/Plots/Raw_vs_MLS_zoom.pdf}
...
%
                        \begin{figure}
        \centering
\includegraphics[width=1.2\textwidth]{../../Files/lauder/DQA_nors80/Binned/Plots/DQA_vs_NDACC_alltimerange.png}
%        \includegraphics[width=0.9\textwidth]{../../Files/lauder/MLS/Plots/Raw_vs_MLS_zoom.pdf}
...
\ref{fig:dqav05} and \ref{fig:niwav05}.
                            ...
                            \begin{figure}
        \centering
\includegraphics[width=1.2\textwidth]{../../Files/lauder/MLS/Plots/DQA_vs_MLS_v05.png}
%        \includegraphics[width=0.9\textwidth]{../../Files/lauder/MLS/Plots/Raw_vs_MLS_zoom.pdf}
    ...
    \end{figure}
                                ...
                                \begin{figure}
        \centering
\includegraphics[width=1.2\textwidth]{../../Files/lauder/MLS/Plots/Original_vs_MLS_v05.png}
%        \includegraphics[width=0.9\textwidth]{../../Files/lauder/MLS/Plots/Raw_vs_MLS_zoom.pdf}
