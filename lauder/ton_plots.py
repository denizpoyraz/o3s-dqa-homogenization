...
#     metadata.append(df)
#
# name_out = 'Lauder_Metada_DQA_rs80'
...
dfm1 = pd.read_csv('/home/poyraden/Analysis/Homogenization_public/Files/lauder/DQA_nors80/Lauder_Metada_DQA_nors80.csv')
dfm2 = pd.read_csv('/home/poyraden/Analysis/Homogenization_public/Files/lauder/DQA_rs80/Lauder_Metada_DQA_rs80.csv')


# /home/poyraden/Analysis/Homogenization_public/Files/lauder/DQA_nors80/Lauder_Metada_DQA_nors80_updated.csv

print(list(dfm1))
#
# dfm2 = pd.read_csv('/home/poyraden/Analysis/Homogenization_public/Files/lauder/DQA_upd/Lauder_Metada_DQA_nors80.csv')
# #
# dfw = pd.read_csv('/home/poyraden/Analysis/Homogenization_public/Files/lauder/Lauder_Metadata.csv')
# # print('dfw', list(dfw))
...
dfm2['DateTime'] = dfm2['DateTime'].apply(lambda x: pd.to_datetime(str(x), format='%Y-%m-%d %H'))
dfm2['Date'] = dfm2['DateTime'].dt.strftime('%Y-%m-%d')
#
#
...
dfm1['rdif'] = (dfm1['O3SondeTotal_hom'] - dfm1['Dobson'])/dfm1['O3SondeTotal_hom']*100
dfm2['rdif'] = (dfm2['O3SondeTotal_hom'] - dfm2['Dobson'])/dfm2['O3SondeTotal_hom']*100


Plotname = 'TON_factor_DQA_rs80vsnors80'
...
# axs[2].plot(x, y, '+')
#
axs.plot(dfm2.DateTime, dfm2.rdif, label='RDif RS80', marker=".", linestyle='None')
axs.plot(dfm1.DateTime, dfm1.rdif, label='RDif noRS80', marker=".", linestyle='None')

axs.set_ylabel('(ECC - Dobson)/ECC [%]')
axs.set_ylim(-20, 20)
...
dfm1['ratio'] = dfm1['Dobson']/dfm1['O3SondeTotal']
dfm1['ratio_raw'] = dfm1['Dobson']/dfm1['O3SondeTotal_raw']
dfm1['ratio_hom'] = dfm1['Dobson']/dfm1['O3SondeTotal_hom']
...
Plotname = 'TON_sonde_nors80_2section'

fig, axs = plt.subplots(2, sharex=True, sharey=False, figsize=(17, 9))
fig.suptitle('Lauder TO and TON values')
...
axs[0].plot(dfm1.DateTime, dfm1.O3Sonde, label = 'O3Sonde NIWA',  marker = ".",  linestyle='None')
axs[0].plot(dfm1.DateTime, dfm1.Dobson, label = 'Brewer TO',  marker = ".", linestyle='None')
...
# axs[1].plot(dfm1.DateTime, dfm1.Dobson, label = 'Brewer TO',  marker = ".", linestyle='None')
# axs[1].set_ylabel('O3 [DU]')
# axs[1].legend(loc="upper right")

axs[1].plot(dfm1.DateTime, dfm1.ratio_hom, label = 'TON DQA',  marker = "s", linestyle='None', markersize = 4)
# axs[2].plot(dfm1.DateTime, dfm1.ratio_raw, label = 'TON Raw ',  marker = ".", linestyle='None')
axs[1].plot(dfm1.DateTime, dfm1.ratio, label = 'TON NIWA',  marker = ".", linestyle='None')

axs[1].set_ylabel('TON')
axs[1].legend(loc="upper right")
...
# # axs[2].plot(dfm1.DateTime, dfm1.Dobson, label = 'Brewer', marker = ".",  linestyle = ''None'')
# # axs[2].plot(dfm1.DateTime, dfm1.O3SondeTotal_hom, label = 'O3Sonde_DQA + ROC',  marker = "." )
# axs[2].plot(dfm1.DateTime, dfm1.Dobson, label='Brewer', marker=".")
