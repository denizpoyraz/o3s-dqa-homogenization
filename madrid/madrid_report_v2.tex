...
Madrid ozonesonde data is taken from WOUDC data-server and the metadata is provided by the station PI. The timeseries in WOUDC server starts from 1994.
There are missing metadata which are temperature (TLab),
pressure (PLab) values of the laboratory conditions  before 2006-02-26, and humidity (ULab) of the laboratory before 2020-11-18.
...
Some of the pump temperature values in WOUDC files, before 2006, are missing.
For those data files the climatological means of the pump temperatures
with 2 sigma uncertainty are used. Among these files, if the number of data points are considerably less with respect to the total number
of points (less than $~20\%$), the missing pump temperature values are interpolated.
...
2004. Therefore the mean and corresponding standar deviations are calculated and applied seperately in these 2 periods.
                ...
                \begin{figure}
        \centering
\includegraphics[width=1.3\textwidth]{../../Files/madrid/DQA_nors80/Binned/Plots/EtaBkg_vs_Eta_alltimerange_rs.png}
%        \includegraphics[width=0.9\textwidth]{../../Files/madrid/MLS/Plots/Raw_vs_MLS_zoom.pdf}
...
%
                    \begin{figure}
        \centering
\includegraphics[width=1.2\textwidth]{../../Files/madrid/DQA_nors80/Binned/Plots/EtaBkgTpump_vs_EtaBkg_alltimerange_rs.png}
%        \includegraphics[width=0.9\textwidth]{../../Files/madrid/MLS/Plots/Raw_vs_MLS_zoom.pdf}
...
%
    ...
    correction is explained in Sec~\ref{sec:metadata}.
                        ...
                        \begin{figure}
        \centering
\includegraphics[width=1.2\textwidth]{../../Files/madrid/DQA_nors80/Binned/Plots/EtaBkgTpumpPhigr_vs_EtaBkgTpump_alltimerange_rs.png}
%        \includegraphics[width=0.9\textwidth]{../../Files/madrid/MLS/Plots/Raw_vs_MLS_zoom.pdf}
...
and polynomial fit with an error of less than $0.03\%$. The effect of this correction is shown in Fig~\ref{fig:pf_eff}.
                        ...
                        \begin{figure}
        \centering
\includegraphics[width=1.2\textwidth]{../../Files/madrid/DQA_nors80/Binned/Plots/EtaBkgTpumpPhigrPhiEff_vs_EtaBkgTpumpPhigr_alltimerange_rs.png}
%        \includegraphics[width=0.9\textwidth]{../../Files/madrid/MLS/Plots/Raw_vs_MLS_zoom.pdf}
    \caption{Pump flow rate correction applied}
            \label{fig:pf_eff}
    \end{figure}
...
%                        \begin{figure}
%        \centering
%\includegraphics[width=1.2\textwidth]{../../Files/madrid/DQA_nors80/Binned/Plots/RS80_vs_noRS80.png}
%%        \includegraphics[width=0.9\textwidth]{../../Files/madrid/MLS/Plots/Raw_vs_MLS_zoom.pdf}
...
WOUDC O3S values is shown in Fig~\ref{fig:fig_dqa_ndacc}.
                        ...
                        \begin{figure}
        \centering
\includegraphics[width=1.2\textwidth]{../../Files/madrid/DQA_nors80/Binned/Plots/DQA_vs_Raw_alltimerange_unzoom_rs.png}
%        \includegraphics[width=0.9\textwidth]{../../Files/madrid/MLS/Plots/Raw_vs_MLS_zoom.pdf}
    ...
    \end{figure}
                        ...
                        \begin{figure}
        \centering
\includegraphics[width=1.2\textwidth]{../../Files/madrid/DQA_nors80/Binned/Plots/DQA_vs_WOUDC_alltimerange_rs.png}
%        \includegraphics[width=0.9\textwidth]{../../Files/madrid/MLS/Plots/Raw_vs_MLS_zoom.pdf}
...
in the pump temperature location.
    All the plots are summarized between Fig.\ref{fig:pl_before} to Fig.\ref{fig:op_all}.
                                ...
                                \begin{figure}
        \centering
\includegraphics[width=1.2\textwidth]{../../Files/madrid/Plots/Before_1998_effectPTC.png}
%        \includegraphics[width=0.9\textwidth]{../../Files/madrid/MLS/Plots/Raw_vs_MLS_zoom.pdf}
    ...
    \end{figure}
                                    ...
                                    \begin{figure}
        \centering
\includegraphics[width=1.2\textwidth]{../../Files/madrid/Plots/After_1998_effectPTC.png}
%        \includegraphics[width=0.9\textwidth]{../../Files/madrid/MLS/Plots/Raw_vs_MLS_zoom.pdf}
...
\includegraphics[width=1.2\textwidth]{../../Files/madrid/Plots/AllPeriod_WOUDC_DQA_Raw.png}
%        \includegraphics[width=0.9\textwidth]{../../Files/madrid/MLS/Plots/Raw_vs_MLS_zoom.pdf}
...
climatological means, are added. The corresponding plots are shown in Fig.\ref{fig:ton1} and  Fig.\ref{fig:ton2}.
                                                ...
                                                \begin{figure}
        \centering
\includegraphics[width=1.2\textwidth]{../../Files/madrid/Plots/TON_updated/TON_allplots_v1.png}
%        \includegraphics[width=0.9\textwidth]{../../Files/madrid/MLS/Plots/Raw_vs_MLS_zoom.pdf}
    ...
    \end{figure}
                                                ...
                                                \begin{figure}
        \centering
\includegraphics[width=1.2\textwidth]{../../Files/madrid/Plots/TON_updated/TON_allplots_v2.png}
%        \includegraphics[width=0.9\textwidth]{../../Files/madrid/MLS/Plots/Raw_vs_MLS_zoom.pdf}
...
\ref{fig:rawv04} and \ref{fig:o3sv04}.
                            ...
                            \begin{figure}
        \centering
\includegraphics[width=1.2\textwidth]{../../Files/madrid/MLS/Plots/DQA_vs_MLS_v04_nors80.png}
%        \includegraphics[width=0.9\textwidth]{../../Files/madrid/MLS/Plots/Raw_vs_MLS_zoom.pdf}
    ...
    \end{figure}
                                ...
                                \begin{figure}
        \centering
\includegraphics[width=1.2\textwidth]{../../Files/madrid/MLS/Plots/WOUDC_vs_MLS_v04_nors80.png}
%        \includegraphics[width=0.9\textwidth]{../../Files/madrid/MLS/Plots/Raw_vs_MLS_zoom.pdf}
    ...
    \end{figure}
                                ...
                                \begin{figure}
        \centering
\includegraphics[width=1.2\textwidth]{../../Files/madrid/MLS/Plots/DQA_vs_MLS_v05_nors80.png}
%        \includegraphics[width=0.9\textwidth]{../../Files/madrid/MLS/Plots/Raw_vs_MLS_zoom.pdf}
