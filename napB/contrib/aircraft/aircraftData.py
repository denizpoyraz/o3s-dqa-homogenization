...
class AircraftData:
    ...
    def _subSampleBySelection(self, var, timeVar, flagVar, samplingRate, flagsToUse):
        ...
        """
        if samplingRate!=1:
            raise ValueError("Sampling rates of values other than 1Hz are not yet supported.")
        ...
        if shape[1]==1:
            ...
            for t0 in range(shape[0]):
                ...
                if samplingRate==1:
                    ...
                    raise ValueError("Averaging for non 1Hz sampling rates not yet supported!")
    ...
    def _flatten2DTimeAxis(self, timevar, samplingRate):
        ...
        """
        if samplingRate!=1:
            raise ValueError("Cannot yet deal with sub-sampling to non 1Hz sampling rates!")
