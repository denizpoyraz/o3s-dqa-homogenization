...
class NAContentCollector(NACore):
	...
	if not bestVar:  
        ...
        if ndims in (2,3,4):
            ...
            raise ValueError("Cannot write variables defined against greater than 4 axes in NASA Ames format.")
        else:
        ...
        if ruleName=="aircraft":
            ...
            if rule[2]=="flag":
                ...
                try:
                    ...
                    raise ValueError("Cannot get flag variable for '%s'" % var.id)
            elif rule[2]=="noflag":
                flagVar=None
            ...
            raise ValueError("Rule '%s' not yet defined." % ruleName)
