...
class NAFile1001(napB.na_file.na_file.NAFile):
    """
    ...
    def _readData1(self, datalines, ivar_count):
        ...
        """
        (x_and_v, rtlines) = napB.utils.text_parser.readItemsFromUnknownLines(datalines, 1 + self.NV, float)
