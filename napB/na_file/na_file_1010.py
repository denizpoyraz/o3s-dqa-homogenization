...
import napB.na_file.na_file_1001
...
class NAFile1010(napB.na_file.na_file.NAFile):
    """
    ...
    def readHeader(self):
        ...
        self.DX = napB.utils.text_parser.readItemsFromLine(self.file.readline(), self.NIV, float)
        self.XNAME = napB.utils.text_parser.readItemsFromLines(self._readLines(self.NIV), self.NIV, str)
    ...
    def _readData1(self, datalines, ivar_count): 
        ...
        (x2_and_a, rtlines) = napB.utils.text_parser.readItemsFromUnknownLines(datalines, 1 + self.NAUXV, float)
    ...
    def _readData2(self, datalines, ivar_count):
        ...
        (v, rtlines) = napB.utils.text_parser.readItemsFromUnknownLines(datalines, self.NV, float)              
