...
for (filename) in (allFiles):
    ...
    try:
        rsmodel = dfm.at[dfm.first_valid_index(), 'RadiosondeModel']
    except KeyError:
        rsmodel = 'RS92'
    ...
    df['alpha_o3'], df['unc_alpha_o3'] = absorption_efficiency(df, 'Pair',
                                                               dfm.at[dfm.first_valid_index(), 'SolutionVolume'])
    ...
    # ground correction
    df['Phip_ground'], df['unc_Phip_ground'] = pf_groundcorrection(df, dfm, 'Phip', 'dPhip', 'TLab', 'Pground', 'ULab',
                                                                   True)
    ...
    md_clist = ['Phip', 'Eta', 'unc_Phip', 'unc_Tpump', 'unc_cPH', 'unc_cPL', 'unc_alpha_o3', 'alpha_o3', 'stoich',
                'unc_stoich',
                'eta_c', 'unc_eta', 'unc_eta_c', 'iBc', 'unc_iBc', 'unc_Tpump_cor', 'deltat', 'unc_deltat',
                'unc_deltat_ppi',
