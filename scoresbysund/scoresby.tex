...
%
                \begin{figure}
        \centering
\includegraphics[width=1.3\textwidth]{../../Files/scoresby/DQA_nors80/Binned/Plots/Eta_vs_Raw_alltimerange.png}
...
%%
                \begin{figure}
        \centering
\includegraphics[width=1.3\textwidth]{../../Files/scoresby/DQA_nors80/Binned/Plots/EtaBkg_vs_Eta_alltimerange.png}
...
%
                    \begin{figure}
        \centering
\includegraphics[width=1.2\textwidth]{../../Files/scoresby/DQA_nors80/Binned/Plots/EtaBkgTpump_vs_EtaBkg_alltimerange.png}
...
%
                        \begin{figure}
        \centering
\includegraphics[width=1.2\textwidth]{../../Files/scoresby/DQA_nors80/Binned/Plots/EtaBkgTpumpPhigr_vs_EtaBkgTpump_alltimerange.png}
...
%
                        \begin{figure}
        \centering
\includegraphics[width=1.2\textwidth]{../../Files/scoresby/DQA_nors80/Binned/Plots/EtaBkgTpumpPhigrPhiEff_vs_EtaBkgTpumpPhigr_alltimerange.png}
    \caption{Pump flow rate correction applied}
            \label{fig:pf_eff}
    \end{figure}
%%
...
WOUDC O3S values is shown in Fig~\ref{fig:fig_dqa_ndacc}.
                        ...
                        \begin{figure}
        \centering
\includegraphics[width=1.2\textwidth]{../../Files/scoresby/DQA_nors80/Binned/Plots/DQA_vs_Raw_alltimerange.png}
%        \includegraphics[width=0.9\textwidth]{../../Files/scoresby/MLS/Plots/Raw_vs_MLS_zoom.pdf}
...
%
                        \begin{figure}
        \centering
\includegraphics[width=1.2\textwidth]{../../Files/scoresby/DQA_nors80/Binned/Plots/DQA_vs_NDACC_alltimerange.png}
%        \includegraphics[width=0.9\textwidth]{../../Files/scoresby/MLS/Plots/Raw_vs_MLS_zoom.pdf}
...
%total uncertainity of the ozone partial pressure and also in the final DQA ver.
    The effect of RS80 correction is shown in Fig~\ref{fig:rs80}. \\
                        ...
                        \begin{figure}
        \centering
\includegraphics[width=1.2\textwidth]{../../Files/scoresby/DQA_nors80/Binned/Plots/RS80_vs_noRS80.png}
%        \includegraphics[width=0.9\textwidth]{../../Files/scoresby/MLS/Plots/Raw_vs_MLS_zoom.pdf}
