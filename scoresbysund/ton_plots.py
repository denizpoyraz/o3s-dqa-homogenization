...
dfm1 = pd.read_csv('/home/poyraden/Analysis/Homogenization_public/Files/scoresby/DQA_nors80/Scoresby_Metada_DQA_nors80_till202.csv')
print(list(dfm1))
...
df1['rdif_r'] = (df1['O3SondeTotal_hom'] - df1['O3SondeTotal']) /df1['O3SondeTotal_hom'] * 100
