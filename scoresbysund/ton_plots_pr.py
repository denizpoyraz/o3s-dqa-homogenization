...
#     metadata.append(df)
#
# name_out = 'Scoresby_Metada_DQA_nors80'
...
dfm1 = pd.read_csv('/home/poyraden/Analysis/Homogenization_public/Files/scoresby/DQA_nors80/Scoresby_Metada_DQA_nors80.csv')
...
axs.plot(dfm1.DateTime, dfm1.O3SondeTotal_hom, label = 'O3Sonde DQA',  marker = "s", markersize = 4)
# axs[0].plot(dfm1.DateTime, dfm1.O3Sonde_raw, label = 'O3Sonde Raw',  marker = ".", linestyle='None')
axs.plot(dfm1.DateTime, dfm1.O3SondeTotal, label = 'O3Sonde NDACC',  marker = ".")
...
axs[0].plot(dfm1.DateTime, dfm1.O3SondeTotal_hom, label = 'O3Sonde DQA',  marker = "s", linestyle='None', markersize = 4)
# axs[0].plot(dfm1.DateTime, dfm1.O3Sonde_raw, label = 'O3Sonde Raw',  marker = ".", linestyle='None')
axs[0].plot(dfm1.DateTime, dfm1.O3SondeTotal, label = 'O3Sonde NDACC',  marker = ".",  linestyle='None')
