...
allFiles = sorted(glob.glob(path + 'DQA_nors80_v2/*o3smetadata_nors80.csv'))
...
#
# dfall.to_csv('/home/poyraden/Analysis/Homogenization_public/Files/uccle/DQA_nors80_v2/' + name_out + ".csv")
# dfall.to_hdf('/home/poyraden/Analysis/Homogenization_public/Files/uccle/DQA_nors80_v2/' + name_out + ".h5", key = 'df')

dfm1 = pd.read_csv('/home/poyraden/Analysis/Homogenization_public/Files/uccle/DQA_nors80_v2/Uccle_Metada_DQA_nors80.csv')
...
dfm1 = dfm1[dfm1.TO_Brewer > 0]
dfm1 = dfm1[dfm1.TO_Brewer < 999]
...
axs[0].plot(dfm1.DateTime, 100*(dfm1.O3Sonde_10hpa_etabkg - dfm1.O3Sonde_10hpa_raw)/dfm1.O3Sonde_10hpa_raw ,
...
axs[1].plot(dfm1.DateTime, 100*(dfm1.O3Sonde_10hpa_etabkgtpump - dfm1.O3Sonde_10hpa_etabkg)/dfm1.O3Sonde_10hpa_etabkg ,
            label = 'Effect of Pump Temp. corr. on TO [%] ',  marker = ".", linestyle='None')
axs[1].set_ylabel('%')
# axs[1].set_ylim(0, 5)
axs[1].legend(loc="upper right")

axs[2].plot(dfm1.DateTime, 100*(dfm1.O3Sonde_10hpa_etabkgtpumpphigr - dfm1.O3Sonde_10hpa_etabkgtpump)/dfm1.O3Sonde_10hpa_etabkgtpump ,
            label = 'Effect of PF humidity corr. on TO [%] ',  marker = ".", linestyle='None')
axs[2].set_ylabel('%')
# axs[2].set_ylim(-5, 5)
axs[2].legend(loc="upper right")

axs[3].plot(dfm1.DateTime, 100*(dfm1.O3Sonde_10hpa_hom - dfm1.O3Sonde_10hpa_etabkgtpumpphigr)/dfm1.O3Sonde_10hpa_etabkgtpumpphigr ,
...
axs[4].plot(dfm1.DateTime, (dfm1.O3Sonde_10hpa_hom - dfm1.O3Sonde_10hpa_raw)/dfm1.O3Sonde_10hpa_raw * 100 ,
...
axs[5].plot(dfm1.DateTime, (dfm1.O3Sonde_10hpa_hom - dfm1.O3Sonde_10hpa)/dfm1.O3Sonde_10hpa * 100 ,
...
# axs[5].plot(dfm1.DateTime, (dfm1.O3Sonde_burst- dfm1.O3Sonde_burst)/dfm1.O3Sonde_burst * 100 , label = 'O3Sonde DQA - WOUDC [%]', marker = ".")
...
path = '/home/poyraden/Analysis/Homogenization_public/Files/uccle/'
plt.savefig(path + 'Plots/TON_v2/' + Plotname + '.png')
...
# axs.plot(dfm1.DateTime, dfm1.O3Sonde_burst, label = 'O3Sonde DQA(rvm) burst',  marker = ".")
axs[0].plot(dfm1.DateTime, dfm1.O3Sonde_burst_hom, label = 'O3Sonde DQA burst',  marker = "s", linestyle='None', markersize = 4)
axs[0].plot(dfm1.DateTime, dfm1.O3Sonde_burst_raw, label = 'O3Sonde Raw burst',  marker = ".", linestyle='None')
axs[0].set_ylabel('O3 [DU]')
axs[0].legend(loc="upper right")


axs[1].plot(dfm1.DateTime, dfm1.O3Sonde_10hpa_hom, label = 'O3Sonde DQA 10hPa',  marker = "s", linestyle='None', markersize = 4)
axs[1].plot(dfm1.DateTime, dfm1.O3Sonde_10hpa_raw, label = 'O3Sonde Raw 10hPa',  marker = ".", linestyle='None')
axs[1].set_ylabel('O3 [DU]')
axs[1].legend(loc="upper right")


axs[2].plot(dfm1.DateTime, dfm1.TO_Brewer, label = 'Brewer TO',  marker = ".", linestyle='None')
axs[2].set_ylabel('O3 [DU]')
axs[2].legend(loc="upper right")

axs[3].plot(dfm1.DateTime, dfm1.O3ratio_hom, label = 'TON DQA',  marker = "s", linestyle='None', markersize = 4)
axs[3].plot(dfm1.DateTime, dfm1.O3ratio, label = 'TON Raw ',  marker = ".", linestyle='None')
...
# axs.plot(dfm1.DateTime, dfm1.O3Sonde_burst_hom, label = 'O3Sonde DQA burst',  marker = ".")
