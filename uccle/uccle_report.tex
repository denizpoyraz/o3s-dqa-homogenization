...
\label{sec:metadata}
    ...
    \begin{figure}[H]
        \centering
\includegraphics[width=1.2\textwidth]{../../Files/uccle/Plots/Metadata/iB0}
%        \includegraphics[width=0.9\textwidth]{../../Files/uccle/MLS/Plots/Raw_vs_MLS_zoom.pdf}
    ...
    \begin{figure}
        \centering
\includegraphics[width=1.2\textwidth]{../../Files/uccle/Plots/Metadata/iB1}
%        \includegraphics[width=0.9\textwidth]{../../Files/uccle/MLS/Plots/Raw_vs_MLS_zoom.pdf}
    ...
    \begin{figure}
        \centering
\includegraphics[width=1.2\textwidth]{../../Files/uccle/Plots/Metadata/PF}
%        \includegraphics[width=0.9\textwidth]{../../Files/uccle/MLS/Plots/Raw_vs_MLS_zoom.pdf}
...
all the DQA corrections except RS80 correction is applied.
    ...
    \begin{figure}
        \centering
\includegraphics[width=1.2\textwidth]{../../Files/uccle/MLS/Plots/DQA_vs_MLS_v04_rs80_test.png}
%        \includegraphics[width=0.9\textwidth]{../../Files/uccle/MLS/Plots/Raw_vs_MLS_zoom.pdf}
    ...
    \begin{figure}
        \centering
\includegraphics[width=1.2\textwidth]{../../Files/uccle/MLS/Plots/DQA_vs_MLS_v04_nors80_test.png}
%        \includegraphics[width=0.9\textwidth]{../../Files/uccle/MLS/Plots/Raw_vs_MLS_zoom.pdf}
...
In Fig~\ref{fig:mlsv5_uccle} the comparison of MLS v05 with Uccle data-set DQA corrections applied is shown.
    ...
    \begin{figure}
        \centering
\includegraphics[width=1.2\textwidth]{../../Files/uccle/MLS/Plots/DQA_vs_MLS_v05_rs80_test.png}
%        \includegraphics[width=0.9\textwidth]{../../Files/uccle/MLS/Plots/Raw_vs_MLS_zoom.pdf}
