...
# dfam = pd.read_csv('/home/poyraden/Analysis/Homogenization_public/Files/valentia/CSV/DQM/valentia_metadata_woudc.csv')
...
#
# dfml.to_csv('/home/poyraden/Analysis/Homogenization_public/Files/valentia/CSV/DQM/valentia_metadata.csv')
...
# dfw = pd.read_csv(path + 'CSV/DQM/valentia_metadata.csv')
#
